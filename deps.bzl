...
def go_dependencies():
    ...
    go_repository(
        name = "com_github_slimsag_freeport",
        importpath = "github.com/slimsag/freeport",
        sum = "h1:5R8Q/HTsObA+Rr3UQlvC1VJDQLOxZX2lnDgjMH8N5ks=",
        version = "v0.0.0-20200820000215-330cfe47953a",
    )
    go_repository(
